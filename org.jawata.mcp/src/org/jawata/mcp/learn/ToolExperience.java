 ...
 * {@code ToolExperience} (a mutate's compile result, a tool error, a fallback).
 * A routine successful read/search never produces one — the tool always
 * answers, so it carries no experience.
 *
